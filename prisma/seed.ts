  ...
  const services = await prisma.$transaction([
    prisma.service.create({
      data: {
        ...
        categoryId: hair.id,
        name: 'Women Haircut',
        description: 'Signature cut, wash, and style tailored to each client.',
        durationMinutes: 60,
        priceCents: 9500,
        active: true,
      },
    ...
    prisma.service.create({
      data: {
        ...
        categoryId: hair.id,
        name: 'Men Haircut',
        description: 'Classic or modern cut finished with a tidy style.',
        durationMinutes: 45,
        priceCents: 6500,
        active: true,
      },
    ...
    prisma.service.create({
      data: {
        ...
        description: 'Full colour service including toning and professional blow dry.',
        durationMinutes: 120,
        priceCents: 18500,
        active: true,
      },
    ...
    prisma.service.create({
      data: {
        ...
        categoryId: nails.id,
        name: 'Manicure',
        description: 'Nail shaping, cuticle care, and polish with hand massage.',
        durationMinutes: 40,
        priceCents: 5500,
        active: true,
      },
    ...
    prisma.service.create({
      data: {
        ...
        categoryId: nails.id,
        name: 'Pedicure',
        description: 'Spa pedicure with exfoliation, cuticle care, and polish.',
        durationMinutes: 50,
        priceCents: 7500,
        active: true,
      },
